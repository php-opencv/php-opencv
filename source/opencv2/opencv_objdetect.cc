...
const zend_function_entry opencv_facedetectoryn_methods[] = {
        PHP_ME(opencv_facedetectoryn, create, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
        PHP_ME(opencv_facedetectoryn, detect, NULL, ZEND_ACC_PUBLIC)
        PHP_ME(opencv_facedetectoryn, getInputSize, NULL, ZEND_ACC_PUBLIC)
        PHP_ME(opencv_facedetectoryn, getNMSThreshold, NULL, ZEND_ACC_PUBLIC)
        PHP_ME(opencv_facedetectoryn, getScoreThreshold, NULL, ZEND_ACC_PUBLIC)
        PHP_ME(opencv_facedetectoryn, getTopK, NULL, ZEND_ACC_PUBLIC)
        PHP_ME(opencv_facedetectoryn, setInputSize, NULL, ZEND_ACC_PUBLIC)
        PHP_ME(opencv_facedetectoryn, setNMSThreshold, NULL, ZEND_ACC_PUBLIC)
        PHP_ME(opencv_facedetectoryn, setScoreThreshold, NULL, ZEND_ACC_PUBLIC)
        PHP_ME(opencv_facedetectoryn, setTopK, NULL, ZEND_ACC_PUBLIC)
        PHP_FE_END
};
/* }}} */
...
const zend_function_entry opencv_facerecognizersf_methods[] = {
        PHP_ME(opencv_facerecognizersf, create, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
        PHP_ME(opencv_facerecognizersf, alignCrop, NULL, ZEND_ACC_PUBLIC)
        PHP_ME(opencv_facerecognizersf, feature, NULL, ZEND_ACC_PUBLIC)
        PHP_ME(opencv_facerecognizersf, match, NULL, ZEND_ACC_PUBLIC)
        PHP_FE_END
};
/* }}} */
